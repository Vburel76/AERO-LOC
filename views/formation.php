...
<p class="text-center mt-4 fs-3 fontTitle">Les formations</p>
...
<section class="row justify-content-center m-0 p-0">
    <article class="col-lg-9 mt-5 ">
        <p class="fs-5 text-center fontTitle">Déroulé de la formation</p>
...
<p class="text-center mt-5 fs-5 fontTitle">Programme de la formation théorique</p>
