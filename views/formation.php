...
<body>
    ...
    <div row class="border d-none d-lg-block border-dark m-0 p-0 FormationImg">
    </div>
    ...
    <h1 class="text-center mt-4  fontTitle">Les formations</h1>

    <p class="fs-3 text-center mt-4  fontTitle">Conditions d'admission pour la formation</p>
    ...
    <section class="row justify-content-center m-0 p-0">
        <article class="col-lg-9 mt-5 ">
            <p class="fs-3 text-center  fontTitle">Déroulé de la formation</p>
    ...
    <div class="row m-0 p-0 justify-content-center ">
        ...
        <div class=" row d-flex justify-content-center mt-3 mb-3 m-0 p-0">
            <button type="button" class="btn col-lg-3 col-10 Textcolor buttonSize">Envoyer</button>
        </div>
