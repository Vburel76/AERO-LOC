                        ...
                        <div class="col-lg-11 col-12">
                            <div class="row justify-content-center m-0 p-0 pt-2 mb-3 rounded roundColor">
                                <div class="col-lg-5 col-10 p-1 rounded">
                                    ...
                                    <br>
                                    <img class="pictureModif mt-2 mb-3" src="../public/img/<?= $infoPlane['plane_picture'] ?>" alt="">
                                    ...
                                    <textarea id="presentationlocPlane" name="presentationlocPlane" class="tailleInput" type="description"> <?= $_POST['presentationlocPlane'] ?? $infoPlane['plane_description'] ?></textarea>
                                </div>
