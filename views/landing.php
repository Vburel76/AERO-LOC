            ...
            <div class="row  m-0 p-0 section1 justify-content-center">
                ...
                <section class="row mt-3 justify-content-center m-3">
                    <article class="col-lg-5 col-12 info  p-0 m-1">
                        ...
                        <p class="mt-4 fontText px-3">Aero-Loc propose une large gamme de services et notamment la location d’avion.
                            En effet apres avoir rempli certaines conditions qui vous serons communiquées , il vous sera possible de louer un avion pour les itinéraires de votre choix.
                        </p>
                    </article>
                    <article class="col-lg-5 col-12 info  p-0 m-1 ">
